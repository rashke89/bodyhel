          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <span
                  className={`inline-block px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(report.status)}`}
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {report.exportedFile.exportedAt && (
                  <div>
                    ...
                    <p className="text-gray-900">
                      {new Date(report.exportedFile.exportedAt).toLocaleString(
                        "sr-RS",
                      )}
                    </p>
                  </div>
